<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('roles.store') }}" method="POST" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            @csrf
            ...
            <div class="flex justify-end gap-3 border-t border-gray-100 pt-6 mt-2">
                ...
                <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-lg font-bold hover:bg-indigo-700 transition shadow-sm">Save Role</button>
            </div>
        </form>
    </div>
</x-app-layout>