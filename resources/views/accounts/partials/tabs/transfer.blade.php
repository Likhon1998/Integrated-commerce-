<div class="max-w-2xl">
    <x-accounts.panel title="Account Transfer" subtitle="Move funds between counters or cash accounts.">
        <form action="{{ route('accounts.transfer.store') }}" method="POST" class="p-6 space-y-4">
            ...
            <div>
                <label class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5">Related Counter (optional)</label>
                <select name="counter_id" class="w-full border-gray-200 rounded-xl text-sm px-3 py-2.5 focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <input type="text" name="description" required class="w-full border-gray-200 rounded-xl text-sm px-3 py-2.5 focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g. Counter 1 to Counter 2 cash shift">
            </div>
