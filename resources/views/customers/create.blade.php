    ...
    <div class="py-6 max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-slate-50 border-b border-gray-100 p-6 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-lg font-black text-gray-800">Customer Details</h3>
                    <p class="text-xs text-gray-500 font-medium mt-0.5">Enter the customer's contact and billing information.</p>
                </div>
            </div>
