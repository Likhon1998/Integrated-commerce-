    ...
    <div class="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li><a href="{{ route('website.shop') }}" class="hover:text-white">Shop</a></li>
        ...
        <div>
            <h5 class="text-white font-semibold mb-3">Payment</h5>
            <p class="text-sm">Cash on Delivery • bKash • Card</p>
        </div>
    </div>
